...
export function Marketplace() {
 ...
 <h1 className="text-4xl md:text-5xl tracking-wide flex items-center gap-3">
 ...
 className="w-full flex items-center justify-between px-4 py-3 text-sm uppercase tracking-wider text-m2e-text-secondary hover:bg-m2e-card-alt transition-colors"
        >
 ...
 <div className="text-xs uppercase tracking-widest text-m2e-text-muted">Quality</div>
 <div className="flex flex-wrap gap-2">
                  {QUALITIES.map((q) => (
 ...
 <div className="text-xs uppercase tracking-widest text-m2e-text-muted">Bike Type</div>
 <div className="flex flex-wrap gap-2">
                  {BIKE_TYPES.map((bt) => (
 ...
 <div className="space-y-2">
 <div className="text-xs uppercase tracking-widest text-m2e-text-muted">Part Type</div>
 <div className="flex flex-wrap gap-2">
                  {PART_TYPES.map((pt) => (
            ...
            {(itemType === '' || itemType === 'part') && (
 <div className="space-y-2">
 <div className="text-xs uppercase tracking-widest text-m2e-text-muted">Part Level</div>
 <div className="flex flex-wrap gap-2">
                  {PART_LEVELS.map((lv) => (
 ...
 className="w-28 px-3 py-2 text-sm bg-m2e-bg-alt text-m2e-text pixel-border outline-none focus:border-m2e-accent"
                />
 ...
 className="w-28 px-3 py-2 text-sm bg-m2e-bg-alt text-m2e-text pixel-border outline-none focus:border-m2e-accent"
            ...
            {hasActiveFilters && (
              <button
                onClick={clearAll}
 className="flex items-center gap-1 px-3 py-1.5 text-xs uppercase tracking-wider pixel-btn pixel-btn-secondary text-m2e-danger"
              >
 ...
 <span className="text-sm text-m2e-text-secondary uppercase tracking-wider">
