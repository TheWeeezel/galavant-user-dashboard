  ...
  return {
    ...
    content: [
      ...
      { type: 'list', items: [
        ...
        'A refill can never take you above your own energy pool, so leaving a session running to collect several refills banks nothing: a long session earns exactly what a fresh one with the same energy earns. Standing still earns nothing either way.',
    ...
    pages: [
       ...
       */
      {
        ...
        content: [
          ...
          { type: 'paragraph', text: 'Most often because the wallet you linked does not hold enough ENJ. Listing puts up a refundable 0.5075 ENJ deposit plus a network fee — about 0.53 ENJ in all — and that comes out of your wallet, because you are the one signing. The Sell screen tells you what the wallet holds and what a listing needs, and keeps the List button off until it adds up. Top the wallet up and the button comes back.' },
          { type: 'paragraph', text: 'The other reason is that the NFT is already on sale. If you set that sale up somewhere other than Galavant, cancel it where you made it and then list it here. The chain will not hold two sales for the same token, and a cancel in Galavant only reaches a sale Galavant created.' },
