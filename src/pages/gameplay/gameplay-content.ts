  ...
  // ─── 6. NFTs & Wallet ─────────────────────────────────────────
  {
    ...
    pages: [
      ...
      },
      {
        ...
        content: [
          { type: 'paragraph', text: 'Once a bike is an on-chain NFT you can sell it on the Galavant marketplace, and there are two very different ways to do it. Which you pick decides what the bike becomes.' },
          ...
          { type: 'list', items: [
            ...
            'A small marketplace fee applies to WATTS sales, just like the in-game marketplace.',
          ]},
      ...
      },
      {
        ...
        content: [
          ...
          { type: 'paragraph', text: 'Because the part now lives on-chain, everything you would normally do with it is paused until you import it back. An NFT part cannot be socketed into a bike, fed into an upgrade, burned to repair a bike\'s HP, or sold on the in-game marketplace. Import it back into the game first and all of that works normally again.' },
          { type: 'heading', text: 'Selling Parts' },
          { type: 'paragraph', text: 'Part NFTs sell on the NFT Market, the same way bikes do: for ENJ it stays an NFT for the buyer, and for WATTS it is burned and the buyer receives it as a normal in-game part. Listing a part pops it out of any bike first, so it always changes hands bare.' },
