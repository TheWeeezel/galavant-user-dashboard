      ...
      },
      {
        ...
        content: [
          ...
          { type: 'list', items: [
            ...
            'Your bike becomes an on-chain NFT and stops being playable — it stays in your inventory, marked as an NFT, so you can sell, sweep or import it.',
      ...
      },
      {
        ...
        content: [
          ...
          { type: 'list', items: [
            ...
            'Creating an ENJ listing locks a small refundable deposit (0.5075 ENJ) in your own Enjin wallet — make sure it is funded first.',
          ]},
          { type: 'heading', text: 'Taking Full Custody' },
          { type: 'paragraph', text: 'Prefer to hold your NFT in your own Enjin wallet and sell it anywhere (like nft.io)? You can sweep it out to your linked wallet at any time. Once you do, it leaves your Galavant inventory entirely — you\'re in full control, and it can only be played again by whoever imports it back.' },
    ...
    pages: [
      ...
      },
      {
        ...
        content: [
          ...
          { type: 'heading', text: 'Listing for ENJ: check your wallet first' },
          { type: 'paragraph', text: 'Creating an ENJ listing locks a small refundable deposit (0.5075 ENJ) in your own Enjin wallet. Galavant covers the transaction fee but not this deposit, so an empty wallet means the listing will fail. You get the deposit back when the listing sells or you cancel it. Listing for WATTS costs you nothing up front.' },
