  ...
  // ─── 6. NFTs & Wallet ─────────────────────────────────────────
  {
    ...
    pages: [
      ...
      },
      {
        ...
        content: [
          { type: 'paragraph', text: 'Bikes you buy from the Bike Store or earn in-game start as normal inventory bikes. Exporting is optional and only needed when you want to move a bike onto the Bitcoin blockchain — for example, to sell or transfer it outside Galavant.' },
          { type: 'paragraph', text: 'Any bike with full HP can be exported as an on-chain NFT (BikeNFT). A small SAP fee applies, and the export only completes if your in-game balance can cover it at mint time.' },
          ...
          { type: 'list', items: [
            ...
            'A small SAP fee is reserved from your in-game balance for the export and only sticks if the mint succeeds.',
