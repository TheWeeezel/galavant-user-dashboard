  ...
  // ─── 6. NFTs & Wallet ─────────────────────────────────────────
  {
    ...
    pages: [
      ...
      },
      {
        ...
        content: [
          { type: 'paragraph', text: 'Bikes you buy from the Bike Store or earn in-game start as normal inventory bikes. Exporting is optional and only needed when you want to move a bike onto the Enjin blockchain — for example, to sell or transfer it outside Galavant.' },
