  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center py-6">
        <h1
          className="text-4xl md:text-5xl font-black uppercase tracking-widest text-m2e-accent"
      ...
      <div className="pixel-card p-5 space-y-3">
        ...
        <span className="inline-block pixel-border border-m2e-info bg-m2e-info/10 px-2 py-1 text-xs font-bold uppercase tracking-wide text-m2e-info">
      ...
      <div className="pixel-card p-5 space-y-4">
        ...
        <p className="text-lg text-m2e-text-secondary">
          Share your referral link. Earn <span className="text-m2e-accent font-black">50 SAT Points</span> when a friend signs up with Google and links their wallet.
        </p>
          ...
          <div className="space-y-4">
            ...
            {referralLink && (
              <div className="space-y-2">
                <p className="text-sm font-bold uppercase tracking-wide text-m2e-text-secondary">
                  Your Referral Link
                </p>
            ...
            {referralStats && (
              <div className="grid grid-cols-3 gap-3">
                <div className="pixel-card p-3 text-center">
                  <span className="text-2xl font-black text-m2e-text">{referralStats.completed}</span>
                  <p className="text-xs font-bold uppercase tracking-wide text-m2e-text-muted mt-1">
                    Successful
                  </p>
                </div>
                <div className="pixel-card p-3 text-center">
                  <span className="text-2xl font-black text-m2e-text">{referralStats.pending}</span>
                  <p className="text-xs font-bold uppercase tracking-wide text-m2e-text-muted mt-1">
                    Pending
                  </p>
                </div>
                <div className="pixel-card p-3 text-center">
                  <span className="text-2xl font-black text-m2e-accent">{referralStats.totalEarned}</span>
                  <p className="text-xs font-bold uppercase tracking-wide text-m2e-text-muted mt-1">
                    SAT Earned
                  </p>
                </div>
      ...
      <div className="pixel-card p-5 space-y-3">
        ...
        <span className="inline-block pixel-border border-m2e-warning bg-m2e-warning/10 px-2 py-1 text-xs font-bold uppercase tracking-wide text-m2e-warning">
          Coming Soon
        </span>
      </div>
